...
try {
    ...
    $_SESSION['successFlag'] = "C";
    $queryError = $e->getMessage();  
    $_SESSION['message'] = "Se ha detectado un problema en la creación de la zona $zoneName, al buscar posibles zonas duplicadas. </br> Descripción del error: " . $queryError ;  
