...
<body>
    ...
    <div class="container">        
        ...
        <div class="divOptions">
            ...
            <a href="usersList.php?userName=&cardNumber=&checkAllUsersFilterGet=" class="itemOption"><p class="itemOptionText">GESTIONAR USUARIOS<i class="fas fa-users-cog d-block"></i></p></a>
            <a href="reservationsList.php?dateFrom=&dateFrom&dateTo=&dateTo&userName=&duserName&cardNumber=&cardNumber&hourFrom=&hourFrom&hourTo=&hourTo&zoneName=&zoneName&checkAllReservationsFilterGet=&checkAllReservationsFilterGet" class="itemOption"><p class="itemOptionText">LISTADO RESERVAS<i class="fas fa-clipboard-list d-block"></i></p></a>
